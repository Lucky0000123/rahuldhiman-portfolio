      ...
      <div className="experience-main">
        ...
        <div className="basic-experience">
          <Fade bottom duration={2000} distance="40px">
            <div className="experience-heading-div page-hero">
              <div className="experience-heading-img-div page-hero-img">
                {/* <img
              ...
              <div className="experience-heading-text-div">
                ...
                <h1 className="experience-heading-text gradient-title">
                  {experience.title}
                </h1>
